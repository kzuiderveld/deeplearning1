...
#        home = expanduser("~")
#        fname = home + '/.keras/models/vgg16_weights.h5'
#        model.load_weights(fname)
  #      try:
 
  #      except KeyError:
  #              model.load_weights_from_hdf5_group(fname)
    ...
    def fit(self, batches, val_batches, epochs=1):
        steps_epoch = batches.samples // batches.batch_size
        val_steps = val_batches.samples // val_batches.batch_size
        self.model.fit_generator(batches, steps_per_epoch=steps_epoch,
                                 epochs=epochs,
